  ...
  items: [
    {
      ...
      image: { url: "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=200", alt: "Coffee" },
    },
    {
      id: "item-2",
      ...
      image: { url: "https://images.unsplash.com/photo-1612187209234-567b6e9a1439?w=200", alt: "Almond Butter" },
    },
    {
      id: "item-3",
      ...
      image: { url: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=200", alt: "Olive Oil" },
    },
  ],
  itemCount: 5,
  shippingAddress: {
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-gray-900">{order.subtotal.formatted}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Shipping</span>
                <span className="text-gray-900">{order.shipping.formatted}</span>
              </div>
              <div className="flex justify-between">
