      ...
      <div className="relative h-full p-6 flex flex-col justify-between text-white">
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xl font-bold tracking-wide">PriceSmart</span>
              {membership.tier && (
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="text-right">
            ...
            <p className={`text-lg font-semibold ${isExpired ? "text-red-400" : isExpiringSoon ? "text-yellow-400" : ""}`}>
        ...
        {membership.points !== undefined && (
          <div className="absolute top-6 right-6 bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
            ...
            <p className="text-lg font-bold">{membership.points.toLocaleString()}</p>
          </div>
        )}
      </div>
    ...
    <div className="relative w-full max-w-md aspect-[1.6/1] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div className="absolute inset-0 p-6 pt-24">
        ...
        <div className="bg-white/80 h-10 rounded mb-4 flex items-center px-4">
          <span className="text-gray-400 text-sm italic">Authorized Signature</span>
        </div>

        {/* Info */}
        <div className="text-xs text-gray-600 space-y-2">
          <p>
            This card is the property of PriceSmart, Inc. and must be returned upon request.
            Not transferable. Use of this card constitutes acceptance of our terms and conditions.
          </p>
          <p>
            For assistance, call: <span className="font-semibold">+506 2201-9600</span>
          </p>
          <p>
